...
# Standard plugins can be found in $ZSH/plugins/sssdsds
# Custom plugins may be added to $ZSH_CUSTOM/plugins/
# Example format: plugins=(rails git textmate ruby lighthouse)
# Add wisely, as too many plugins slow down shell startup.
plugins=(git zoxide zsh-autosuggestions history zsh-syntax-highlighting zsh-bat fzf)
...
#eval "$(oh-my-posh init zsh --config 'https://raw.githubusercontent.com/JanDeDobbeleer/oh-my-posh/refs/heads/main/themes/neko.omp.json')"
...
#eval "$(oh-my-posh init zsh --config 'https://raw.githubusercontent.com/JanDeDobbeleer/oh-my-posh/refs/heads/main/themes/spaceship.omp.json')"
...
if [[ -n "$SSH_CONNECTION" && -z "$FASTFETCH_SHOWN" && -z "$TMUX" ]]; then
    fastfetch
