...
---
zsh plugins=(git zoxide zsh-autosuggestions history zsh-syntax-highlighting zsh-bat fzf) <br>
lazyvim on neovim <br>
oh my posh and oh my zsh on zsh and fish<br>
